...
describe('studyService', () => {
  ...
  describe('update', () => {
    ...
    it('NEW should fail if non-system user is trying to update Open Data study', async () => {
      // BUILD
      const dataIpt = {
    ...
    it('NEW should pass if system is trying to update Open Data study', async () => {
      // BUILD
      const dataIpt = {
        id: 'existingOpenStudy',
        rev: 1,
    ...
    it('NEW should fail if non Open Data study type has non-empty resources list', async () => {
      // BUILD
      const dataIpt = {
        id: 'existingOrgStudy',
        resources: [{ arn: 'arn:aws:s3:::someRandomStudyArn' }],
