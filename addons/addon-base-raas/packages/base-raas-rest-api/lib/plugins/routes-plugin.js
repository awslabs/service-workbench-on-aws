...
const dsAccountController = require('../controllers/ds-account-controller');
...
async function getRoutes(routesMap, pluginRegistry) {
  ...
  const routes = new Map([
    ...
    ['/api/data-sources', [setupAuthContext, prepareContext, ensureActive, ensureAdmin, dsAccountController]],
  ]);
  return routes;
}
