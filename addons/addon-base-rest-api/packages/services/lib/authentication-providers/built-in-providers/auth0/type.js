...
module.exports = {
  ...
  config: {
    ...
    impl: {
      ...
      tokenValidatorUrn: 'urn:service:auth0AuthenticationProviderService/validateToken',
      ...
      provisionerUrn: 'urn:service:auth0AuthenticationProvisionerService/provision',
    },
  },
};
