...
class AwsAccountUpdatePage extends React.Component {
  constructor(props) {
    ...
    this.awsAccountsStore = this.props.awsAccountsStore;
    this.account = this.props.awsAccountsStore.getAwsAccount(this.awsAccountUUID);
  ...
  componentDidMount = async () => {
    await this.awsAccountsStore.load();
  };

  // get account() {
  //   const awsAccountsStore = this.awsAccountsStore;
  //   return awsAccountsStore.getAwsAccount(this.awsAccountUUID) || {};
  // }

  get stackInfo() {
    const name = this.account.cfnStackName;
    const formattedTemplate = '';
    const hasUpdateStackUrl = !!name;
    const createStackUrl = '';
    return { name, formattedTemplate, hasUpdateStackUrl, createStackUrl };
  }
