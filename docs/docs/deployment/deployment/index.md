...
1.	Install the open source tool, Packer v1.6.0 by using packer version manager [pkenv](https://github.com/iamhsa/pkenv).  Packer is used to create a custom AMI which is then pushed to the Service Workbench deployment.
