...
module.exports = function newHandler({ studyService, log = consoleLogger } = {}) {
  const scrape = {
    ...
    ref: 'master',
    subtree: 'datasets',
    filterTags: ['genetic', 'genomic', 'life sciences', 'whole genome sequencing', 'STRIDES', 'cancer', 'population genetics', 'COVID-19', 'health', 'neuroimaging', 'neuroscience', 'cell biology', 'cell imaging', 'bioinformatics'],
  };
