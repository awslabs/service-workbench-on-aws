...
describe('Get workflow templates drafts scenarios', () => {
  let setup;
  let adminSession;
  ...
  describe('Getting workflow template drafts', () => {
    it('should fail for anonymous user', async () => {
      const anonymousSession = await setup.createAnonymousSession();
      await expect(anonymousSession.resources.workflowTemplates.drafts().get()).rejects.toMatchObject({
    ...
    it('should fail for inactive user', async () => {
      ...
      await expect(researcherSession.resources.workflowTemplates.drafts().get()).rejects.toMatchObject({
    ...
    it('should fail for internal guest', async () => {
      ...
      await expect(guestSession.resources.workflowTemplates.drafts().get()).rejects.toMatchObject({
