...
describe('Get costs scenarios', () => {
  ...
  describe('Getting costs on dashboard', () => {
    it('should fail if user is inactive', async () => {
      ...
      await expect(researcherSession.resources.costs.get()).rejects.toMatchObject({
    ...
    it('should fail if internal guest attempts to get index', async () => {
      ...
      await expect(guestSession.resources.costs.get()).rejects.toMatchObject({
    ...
    it('should fail for anonymous user', async () => {
      ...
      await expect(anonymousSession.resources.costs.get()).rejects.toMatchObject({
