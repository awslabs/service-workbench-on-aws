      ...
      "inputManifestForCreate": {
         "sections": [
            ...
            },
            {
               "children": [
                  {
                     "desc": "An identifier for the federated identity provider. This will be used for identifying the IdP. Usually this is configured to be same as the domain name of the IdP (E.g., amazonaws.com).",
         ...
         "sections": [
            {
               "children": [
                  {
                     "desc": "This is a required field. This is used for uniquely identifying the authentication provider. This must be same as the Cognito User Pool Provider URL in \"https://cognito-idp.{aws-region}.amazonaws.com/{user-pool-id}\" format",
                     "name": "id",
                     "rules": "required|string|between:2,64|regex:/^[a-zA-Z][a-zA-Z0-9_-]+$/",
                     "title": "ID",
                     "type": "stringInput"
